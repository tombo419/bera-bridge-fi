...
export default function EsportsLegitimacyArticle() {
  const tags = extractTagsFromArticle("esports-urheilu", "Pelaaminen ja e-urheilu");
  return (
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <Breadcrumbs 
                items={[
                  ...
                  { label: 'E-urheilu legitiminä urheilulajina' }
                ]}
              />
              ...
              <MoreFromCategory 
                currentArticleId="esports-urheilu"
                category="Pelaaminen ja e-urheilu"
                limit={4}
              />
              
                            
              <ArticleTags tags={tags} articleId="esports-urheilu" />
              <ArticleNavigation 
                currentArticleId="esports-urheilu"
                category="Pelaaminen ja e-urheilu"
              />
